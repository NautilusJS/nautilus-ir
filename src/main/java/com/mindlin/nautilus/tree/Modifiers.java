...
/**
 * Represents a bitset to deal with general declaration modifiers.
 * 
 * ## Usage
 * 
 * 
...
public class Modifiers implements Comparable<Modifiers> {
	...
	/**
	 * Valid contexts: Property/Method/Parameter
	 */
	...
	public static final long FLAG_EXPORT   = 1L << 33;
	/** Declaration is exported as default */
	public static final long FLAG_DEFAULT   = 1L << 34;
	...
	public static final Modifiers EXPORT = Modifiers.wrap(FLAG_EXPORT);
	public static final Modifiers DEFAULT = Modifiers.wrap(FLAG_DEFAULT);
	...
	/** Property access modifiers that can be applied to parameter declarations */
	public static final Modifiers MASK_PARAMETER_PROPERTY = Modifiers.wrap(MASK_VISIBILITY.getFlags() | FLAG_READONLY);
	public static final Modifiers MASK_TYPESCRIPT = Modifiers.wrap(FLAG_DECLARE | FLAG_PUBLIC | FLAG_PRIVATE  | FLAG_PROTECTED | FLAG_READONLY | FLAG_ABSTRACT | FLAG_CONST);
	/**
	 * Syntatically-postfix modifiers
	 */
	public static final Modifiers MASK_POSTFIX = Modifiers.wrap(FLAG_OPTIONAL | FLAG_DEFINITE);
	//TODO: finish
	public static final Modifiers MASK_ALL = Modifiers.wrap(FLAG_PUBLIC | FLAG_PROTECTED | FLAG_STATIC | FLAG_READONLY | FLAG_ABSTRACT | FLAG_ASYNC | FLAG_DEFINITE);
	 ...
	 * 
	 * @return True if any flags are set, else false.
	 */
	public boolean any() {
		return this.flags != 0;
	}
