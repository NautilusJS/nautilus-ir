...
public abstract class AbstractTree implements Tree {
	...
	protected final @NonNull SourceRange range;
	/**
	 * Cache our hash here, so we don't cascade every time
	 */
	private transient int hash;
	
	public AbstractTree(@NonNull SourceRange pos) {
		this.range = pos;
	}
	...
	public boolean equivalentTo(Tree other) {
		return other != null && this.getKind() == other.getKind() && this.hashCode() == other.hashCode();
	}
