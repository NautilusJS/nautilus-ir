...
/**
 * Helper for traversing file input.
 * 
 * @author mailmindlin
 */
public interface CharacterStream extends Closeable {
	/**
	...
	default char current() throws IllegalStateException {
		try {
			...
			throw new IllegalStateException("Stream hasn't started yet", e);
		}
	}
	 ...
	 */
	boolean hasNext(long num) throws IllegalArgumentException;
